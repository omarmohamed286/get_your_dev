...
import '../../view_models/notifications_cubit/notifications_cubit.dart';
import '../widgets/accepted_developer_widget.dart';
import '../widgets/new_developer_form.dart';
import '../widgets/rejected_developer_widget.dart';
...
class _AddDeveloperScreenState extends State<AddDeveloperScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<NotificationsCubit>(context).onNotification(() {
